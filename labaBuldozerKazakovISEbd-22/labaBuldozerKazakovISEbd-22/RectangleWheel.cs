...
namespace labaBuldozerKazakovISEbd_22
{
    class RectangleWheel : InterDop
    {
        ...
        public void DrawDop(Graphics g, float x, float y)
        {
            ...
            g.DrawRectangle(pen, x + 102, y + 113, 6, 6);
            g.DrawRectangle(pen, x + 137, y + 113, 6, 6);
            g.DrawRectangle(pen, x + 167, y + 113, 6, 6);
            g.DrawRectangle(pen, x + 182, y + 113, 6, 6);
            if (dopEnum == enumWheel.Five || dopEnum == enumWheel.Six)
            {
                ...
                g.DrawRectangle(pen, x + 187, y + 142, 6, 6);
            }
            if (dopEnum == enumWheel.Six)
            {
                ...
                g.DrawRectangle(pen, x + 92, y + 142, 6, 6);
            }
        }
    }
}
